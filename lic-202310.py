...
# 
#alter user CSNISPLICENCIA identified by S1scool account unlock;
#alter user CSNISPRNPSP identified by S1scool account unlock;
#alter user CSNISPMANDAMIENTOS identified by S1scool account unlock;
#alter user CSNISPVRYR identified by S1scool account unlock;
#alter user CSNISPRNIP identified by S1scool account unlock;

######adicionales
##alter user CSNISPVRYR identified by S1scool account unlock;
#select USERNAME,PASSWORD from dba_users where account_status='EXPIRED' order by 1;
#
#alter user CSNISPLN identified by S1scool account unlock;
#alter user SNISPRNPSP identified by S1scool account unlock;
#alter user CSNISPRNIP identified by S1scool account unlock;
#alter user CSNISPIPH identified by S1scool account unlock;
#alter user SNISPLN identified by S1scool account unlock;
...
'userName': "CSNISPLICENCIA",
   ...
   'fileName': "" ,
    ...
    'tableDef': {
        'schema': "CSNISPLICENCIA",
        'tableName': "Z_PYLOAD_LICENCIA_FEB2026",
        'truncate': True
    }
}

fileFullPath = "/home/carpeta-bbdd/202310/licencias202310/{fileName}"
